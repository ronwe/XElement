...
var Parser = {
  loop: function(node, itemContent, xAttrs, method, index, item, property = {}, position = null) {
...
export function parseAttribute(node, attr, {property, method}) {
	...
	if (eventName) {
        ...
        if (attrValue.indexOf(' in ') > 0) {
          ...
          console.log('aliasParsed', aliasParsed);
